...
const HomePage: React.FC = () => {
  const features = [
    {
      icon: Code2,
      title: 'フルスタック開発',
      description: 'React、Laravel、WordPress、PHPを使用した最新のWebアプリケーション開発'
    },
    {
      icon: Palette,
      title: 'UI/UXデザイン',
  ...
  const stats = [
    { number: '150+', label: 'プロジェクト完了' },
    { number: '80+', label: '満足いただいたクライアント' },
    { number: '8+', label: '年の経験' },
    { number: '20+', label: '技術スタック' }
  ];
  ...
  const freelanceHighlights = [
    {
      icon: Briefcase,
      title: 'フリーランス専門',
      description: '2024年より独立し、柔軟で迅速な対応を実現'
    },
    {
      icon: Clock,
      title: '迅速な対応',
    ...
    },
    {
      icon: Star,
      title: '豊富な実績',
      description: '8年以上の経験と150以上のプロジェクト実績'
    }
  ];
