...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    { icon: Github, href: 'https://github.com/ninjia-yeti', label: 'GitHub' },
    { icon: Mail, href: 'mailto:michizoeharuki@gmail.com', label: 'メール' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold font-zen-kaku mb-4">
              道添 春樹
            </h3>
            <p className="text-gray-400 mb-6">
              8年以上の経験を持つフリーランス フルスタックデベロッパーとして、
              8年以上の経験を活かして、素晴らしいWebソリューションを作り上げます。
              WordPress、Laravel、React等の最新技術で最高品質の成果物を作り続けています。
            </p>
